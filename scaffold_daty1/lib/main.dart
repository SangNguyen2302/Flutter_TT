...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Flutter Scaffold Example Of Nguyen Sang',style: TextStyle(fontSize: 15),),
      ),
                ...
                children: <Widget>[
                  Align(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: NetworkImage('https://media.vov.vn/uploaded/usobwtngx2k/2017_07_13/2_raan.jpg'),
                      radius: 40,
                    ),
                  ),
                  Align(
